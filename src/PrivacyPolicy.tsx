...
const PrivacyPolicy = () => {
  return (
    <div className="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8 flex items-center justify-center">
      <div className="bg-white/90 backdrop-blur-md rounded-lg border border-white/20 shadow-lg p-8 max-w-3xl w-full mx-4">
        ...
        <section className="mb-8">
          ...
          <p className="text-sm text-gray-600 mb-4">
            Welcome to our website. We are committed to protecting your privacy and ensuring that your personal information is handled in a safe and responsible manner. This Privacy Policy outlines how we collect, use, and protect your information when you visit our site.
          </p>
        </section>
        ...
        <section className="mb-8">
          ...
          <ul className="list-disc list-inside text-sm text-gray-600 mb-4">
            <li>Personal information (e.g., name, email address) provided voluntarily by you.</li>
            <li>Non-personal information (e.g., browser type, IP address) collected automatically.</li>
