  ...
  return (
    <AuthContext.Provider
      value={{
        ...
        setUser,
        setToken,
        loginWithGoogle: () => handleOAuthPopup('http://localhost:2000/oauth2/authorization/google'),
        loginWithGithub: () => handleOAuthPopup('http://localhost:2000/oauth2/authorization/github'),
        logout,
        error,
        handleOAuthCallback,
        setIsAuthenticating,
